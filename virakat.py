...
while True:
	...
	elif (("run" in p)  or ("exeute" in p) or ("launch" in p)) and (("editor" in p) or ("notepad" in p)):
	  pyttsx3.speak("opening notepad")
	  os.system("notepad")

	elif (("run" in p)  or ("exeute" in p) or ("launch" in p)) and (("chrome" in p) or ("browser" in p)):
